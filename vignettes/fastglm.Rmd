...
Alternatively, to use the built-in function of `glm()` for processing formulas and data frames, we can use `glm()` with `method = fastglm.fit` to call the *fastglm* fitting functionality:
