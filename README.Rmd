...
The IRLS algorithm reduces every iteration to a weighted least-squares problem. *fastglm* supports six different matrix decompositions for solving that WLS step, all from *RcppEigen*; the choice trades off speed against numerical stability and rank-revealing behavior:
